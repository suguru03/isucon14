...
async fn app_get_notification(
    ...
    let Some(ride): Option<Ride> =
        ...
        return Ok(axum::Json(AppGetNotificationResponse { data: None, retry_after_ms: Some(30) }));
    };
    ...
    Ok(axum::Json(AppGetNotificationResponse { data: Some(data), retry_after_ms: Some(30) }))
}
